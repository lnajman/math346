...
- What observations, if any, were kept out of the fitting process?
...
3. Separates fit error from error on observations not used for fitting.
4. Labels `x = 12` as extrapolation.
5. Refuses or qualifies the prediction if the evidence is weak.
