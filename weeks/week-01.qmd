...
| 25-40 min | Script habit: move command-window work into a reproducible file |
| 40-55 min | Plot sampled functions with labels and legends |
| 55-68 min | Student modification: change domain, sample count, and plotted function |
| 68-75 min | Exit ticket: what did `x`, `y`, and the plot represent? |
...
Complete the [Week 1 exercises](week-01-exercises.qmd) after the lab.
